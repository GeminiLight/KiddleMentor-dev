...
# @st.cache_resource
def schedule_learning_path(learner_profile, session_count, llm_type="gpt-5.1", method_name="genmentor"):
    data = {
        "learner_profile": str(learner_profile),
...
def reschedule_learning_path(learning_path, learner_profile, session_count, other_feedback="", llm_type="gpt-5.1", method_name="genmentor"):
    data = {
