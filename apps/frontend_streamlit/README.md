...
#   Make sure the backend server is up (see ../backend under apps/)
...
- CSS not applied:
  - Confirm `assets/css/main.css` exists and that `main.py` runs from the `apps/frontend_streamlit/` directory so relative paths resolve.
